    ...
    <div className="space-y-4">
      ...
      <div className="relative card-premium p-4">
        ...
        <div 
          ...
          className="flex-shrink-0 w-28 h-36 rounded-[24px] bg-gray-50 border-2 border-dashed border-gray-200 flex flex-col items-center justify-center gap-2 cursor-pointer hover:bg-gray-100 hover:border-emerald-300 transition-all group relative overflow-hidden"
        >
          {uploading ? (
        ...
        {userStories.map((group, index) => (
          <div 
            ...
            className="flex-shrink-0 w-28 h-36 rounded-[24px] overflow-hidden relative cursor-pointer group border-2 border-transparent hover:border-emerald-500 transition-all"
          >
            <img 
